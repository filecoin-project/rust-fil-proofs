...
use crate::constants::{challenge_count, partition_count, TreeRDomain, TreeRHasher};
...
impl Iterator for Challenges {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        if self.i == 0 {
            ...
            let digest: Fr =
                <TreeRHasher as Hasher>::Function::hash2(&self.comm_r_new, &digest_index.into()).into();
