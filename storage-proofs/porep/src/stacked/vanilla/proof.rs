...
impl<'a, Tree: 'static + MerkleTreeTrait, G: 'static + Hasher> StackedDrg<'a, Tree, G> {
        ...
        TreeArity: PoseidonArity,
    {
        #[cfg(feature = "gpu")]
        {
            ...
            return Self::generate_tree_c_gpu::<ColumnArity, TreeArity>(
                layers,
                nodes_count,
                tree_count,
                configs,
        ...
        #[cfg(not(feature = "gpu"))]
        {
            return Self::generate_tree_c_cpu::<ColumnArity, TreeArity>(
                layers,
                nodes_count,
                tree_count,
                configs,
        ...
        TreeArity: PoseidonArity,
    {
        if !settings::SETTINGS.lock().unwrap().use_gpu_tree_builder {
            return Self::generate_tree_r_last_cpu::<TreeArity>(
                data,
                nodes_count,
                tree_count,
                tree_r_last_config,
        ...
        TreeArity: PoseidonArity,
    {
        #[cfg(feature = "gpu")]
        {
            return Self::generate_tree_r_last_gpu::<TreeArity>(
                data,
                nodes_count,
                tree_count,
                tree_r_last_config,
    ...
    #[cfg(feature = "gpu")]
    fn generate_fake_tree_r_last_gpu<TreeArity>(
        nodes_count: usize,
        tree_count: usize,
        tree_r_last_config: StoreConfig,
        replica_path: PathBuf,
    ...
    {
        if !settings::SETTINGS.lock().unwrap().use_gpu_tree_builder {
            return Self::generate_fake_tree_r_last_cpu::<TreeArity>(
                nodes_count,
                tree_count,
                tree_r_last_config,
                replica_path,
    ...
    fn generate_fake_tree_r_last_cpu<TreeArity>(
        nodes_count: usize,
        tree_count: usize,
        tree_r_last_config: StoreConfig,
        replica_path: PathBuf,
        ...
        TreeArity: PoseidonArity,
    {
        #[cfg(feature = "gpu")]
        {
            return Self::generate_fake_tree_r_last_gpu::<TreeArity>(
                nodes_count,
                tree_count,
                tree_r_last_config,
                replica_path,
