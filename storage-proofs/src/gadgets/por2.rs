...
// impl<'a, Tree, E: JubjubEngine + PoseidonEngine<Tree::Arity>, H: Hasher> CircuitComponent
//     for PoRCircuit<'a, Tree, E, H>
// where
//     Tree: MerkleTreeTrait<E, Hasher = H>,
// {
...
//     H: Hasher,
//     E: JubjubEngine + PoseidonEngine<Tree::Arity>,
//     Tree: MerkleTreeTrait<E, Hasher = H>,
// > {
//     _h: PhantomData<H>,
//     _u: PhantomData<Tree>,
