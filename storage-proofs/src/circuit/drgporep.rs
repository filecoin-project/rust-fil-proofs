...
impl<'a, E: JubjubEngine> Circuit<E> for DrgPoRepCircuit<'a, E> {
        ...
        E: JubjubEngine,
    {
        ...
        let prover_id_bits =
            bytes_into_boolean_vec(cs.namespace(|| "prover_id_bits"), replica_id_bytes, lambda)?;
...
mod tests {
    ...
    fn drgporep_input_circuit_with_bls12_381() {
        ...
        assert_eq!(cs.num_constraints(), 58117, "wrong number of constraints");
    ...
    fn drgporep_input_circuit_num_constraints() {
        ...
        assert_eq!(cs.num_inputs(), 18, "wrong number of inputs");
        assert_eq!(cs.num_constraints(), 290293, "wrong number of constraints");
    }
