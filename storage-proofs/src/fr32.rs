...
mod tests {
    ...
    fn test_bytes_into_fr_into_bytes() {
        ...
        bytes_fr_test::<Bls12>(
            ...
            [
                255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 170, 18,
            ],
            true,
        );
        bytes_fr_test::<Bls12>(
            ...
            [
                255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 171, 18,
            ],
            false,
        );
    }
    ...
    fn test_bytes_into_frs_into_bytes() {
        let bytes = b"012345678901234567890123456789-\x12012345678901234567890123456789-\x12012345678901234567890123456789-\x12";
