...
#[derive(Clone, Debug)]
pub struct MessageWord<F: FieldExt>(AssignedBits<F, 32>);
...
#[derive(Clone, Debug)]
pub struct MessageScheduleConfig<F: FieldExt> {
    lookup: SpreadInputs,
...
impl<F: FieldExt> MessageScheduleConfig<F> {
    ...
    pub fn configure(
        ...
        lookup: SpreadInputs,
        message_schedule: Column<Advice>,
        // Columns `a_3, a_4, a_6, a_7, a_8, a_9`.
        advice: [Column<Advice>; 6],
    ) -> Self {
        ...
        let [a_3, a_4, a_6, a_7, a_8, a_9] = advice;
    ...
    fn process_inner(
        ...
        input: [(AssignedBits<F, 32>, (AssignedBits<F, 16>, AssignedBits<F, 16>)); BLOCK_SIZE],
    ) -> Result<
        (
            [MessageWord<F>; ROUNDS],
            [(AssignedBits<F, 16>, AssignedBits<F, 16>); ROUNDS],
