...
pub struct DrgPoRepCircuit<'a, H: Hasher<Field = Fr>> {
...
impl<'a, H: 'static + Hasher<Field = Fr>> DrgPoRepCircuit<'a, H> {
...
impl<'a, H: Hasher<Field = Fr>> CircuitComponent for DrgPoRepCircuit<'a, H> {
...
///
impl<'a, H: 'static + Hasher<Field = Fr>> Circuit<Fr> for DrgPoRepCircuit<'a, H> {
