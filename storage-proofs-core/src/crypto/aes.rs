...
mod tests {
    ...
    fn test_aes() {
        ...
        for i in 0..10 {
            ...
            let ciphertext = encode(key.as_slice(), plaintext.as_slice()).expect("failed to encode");
            ...
            let roundtrip = decode(key.as_slice(), ciphertext.as_slice()).expect("failed to decode");
