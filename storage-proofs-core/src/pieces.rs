...
mod tests {
    ...
    fn test_subtree_capacity() {
        assert_eq!(subtree_capacity(0, 16).expect("subtree_capacity failed"), 16);
        ...
        assert_eq!(subtree_capacity(10, 16).expect("subtree_capacity failed"), 2);
        assert_eq!(subtree_capacity(11, 16).expect("subtree_capacity failed"), 1);
        assert_eq!(subtree_capacity(12, 16).expect("subtree_capacity failed"), 4);
        assert_eq!(subtree_capacity(13, 16).expect("subtree_capacity failed"), 1);
        assert_eq!(subtree_capacity(14, 16).expect("subtree_capacity failed"), 2);
        assert_eq!(subtree_capacity(15, 16).expect("subtree_capacity failed"), 1);
    }
