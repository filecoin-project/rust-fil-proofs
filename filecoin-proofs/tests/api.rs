...
fn test_seal_proof_aggregation_1_2kib_porep_id_v1_1_base_8() -> Result<()> {
    ...
    porep_id[..8].copy_from_slice(&porep_id_v1_1.to_le_bytes());
    assert!(!is_legacy_porep_id(porep_id));
    let verified = aggregate_proofs::<SectorShape2KiB<Fr>>(
        SECTOR_SIZE_2_KIB,
        &porep_id,
        ApiVersion::V1_1_0,
        proofs_to_aggregate,
...
fn test_seal_proof_aggregation_2_4kib_porep_id_v1_1_base_8() -> Result<()> {
    ...
    let porep_id = ARBITRARY_POREP_ID_V1_1_0;
    assert!(!is_legacy_porep_id(porep_id));
    let verified = aggregate_proofs::<SectorShape4KiB<Fr>>(
        SECTOR_SIZE_4_KIB,
        &porep_id,
        ApiVersion::V1_1_0,
        proofs_to_aggregate,
...
fn test_seal_proof_aggregation_1_32kib_porep_id_v1_1_base_8() -> Result<()> {
    ...
    let porep_id = ARBITRARY_POREP_ID_V1_1_0;
    assert!(!is_legacy_porep_id(porep_id));
    let verified = aggregate_proofs::<SectorShape32KiB<Fr>>(
        SECTOR_SIZE_32_KIB,
        &porep_id,
        ApiVersion::V1_1_0,
        proofs_to_aggregate,
...
fn run_seal_pre_commit_phase1<Tree>(
    config: PoRepConfig,
    prover_id: ProverId,
    sector_id: SectorId,
    ticket: [u8; 32],
