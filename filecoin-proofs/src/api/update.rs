...
use storage_proofs_update::{
    constants::{TreeDArity, TreeDDomain, TreeDHasher, TreeRDomain, TreeRHasher},
    ...
    TreeRHasher<F>: Hasher<Field = F>,
{
    ...
    let proof_bytes = match sector_nodes {
        SECTOR_NODES_1_KIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_1_KIB>::blank_circuit();
        ...
        SECTOR_NODES_2_KIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_2_KIB>::blank_circuit();
        ...
        SECTOR_NODES_4_KIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_4_KIB>::blank_circuit();
        ...
        SECTOR_NODES_8_KIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_8_KIB>::blank_circuit();
        ...
        SECTOR_NODES_16_KIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_16_KIB>::blank_circuit();
        ...
        SECTOR_NODES_32_KIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_32_KIB>::blank_circuit();
        ...
        SECTOR_NODES_8_MIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_8_MIB>::blank_circuit();
        ...
        SECTOR_NODES_16_MIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_16_MIB>::blank_circuit();
        ...
        SECTOR_NODES_512_MIB => {
            let circ =
                EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_512_MIB>::blank_circuit();
        ...
        SECTOR_NODES_32_GIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_32_GIB>::blank_circuit();
        ...
        SECTOR_NODES_64_GIB => {
            let circ = EmptySectorUpdateCircuit::<F, U, V, W, SECTOR_NODES_64_GIB>::blank_circuit();
    ...
    match sector_nodes {
        SECTOR_NODES_1_KIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_1_KIB>>,
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_1_KIB>
        ...
        SECTOR_NODES_2_KIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_2_KIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_2_KIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_4_KIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_4_KIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_4_KIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_8_KIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_8_KIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_8_KIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_16_KIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_16_KIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_16_KIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_32_KIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_32_KIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_32_KIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_8_MIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_8_MIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_8_MIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_16_MIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_16_MIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_16_MIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_512_MIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_512_MIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_512_MIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_32_GIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_32_GIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_32_GIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
        ...
        SECTOR_NODES_64_GIB => {
            let circ_partition_proofs: Vec<
                Halo2Proof<F::Affine, EmptySectorUpdateCircuit<F, U, V, W, SECTOR_NODES_64_GIB>>,
            > = proofs_bytes.map(Into::into).collect();
            ...
            <
                EmptySectorUpdate<F, U, V, W> as halo2::CompoundProof<F, SECTOR_NODES_64_GIB>
            >::verify_all_partitions(
                &vanilla_setup_params,
                &vanilla_pub_inputs,
                &circ_partition_proofs,
