...
ffi_catch_panic!(
    fn verify_post(
        ...
        let post_bytes = try_into_post_proofs_bytes(
            proof_partitions,
...
ffi_catch_panic!(
    fn get_sealed_sectors(ptr: *mut SectorBuilder) -> *mut responses::GetSealedSectorsResponse {
...
ffi_catch_panic!(
    fn get_staged_sectors(ptr: *mut SectorBuilder) -> *mut responses::GetStagedSectorsResponse {
