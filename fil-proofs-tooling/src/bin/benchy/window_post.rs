    ...
    let (seal_pre_commit_phase1_measurement_cpu_time, seal_pre_commit_phase1_measurement_wall_time): (u64, u64) = if skip_precommit_phase1 {
        ...
        let piece_info = if skip_staging {
            let commitment = match sector_size {
                2048 => [0x61,0xbd,0xca,0xac,0x37,0x9c,0xc3,0x55,0x00,0xe6,0x43,0x30,0x3f,0x4c,0xdb,0xc0,0x5e,0x93,0xcf,0xef,0xdc,0xe6,0xb6,0x9f,0xcc,0x81,0xf5,0x4a,0x9b,0x01,0xba,0x1f],
                ...
                _ => panic!("You can only skip this step on known sector sizes, sector size was: {}", sector_size),
            };
