...
//     constants::{DefaultOctLCTree, DefaultPieceHasher},
//     generate_candidates, generate_election_post, generate_piece_commitment, seal_commit_phase1,
//     seal_commit_phase2, seal_pre_commit_phase1, seal_pre_commit_phase2, validate_cache_for_commit,
//     validate_cache_for_precommit_phase2, Candidate, PoStType, PrivateReplicaInfo,
// };
...
//         ),
//     };
//     let phase1_output = seal_pre_commit_phase1::<_, _, _, DefaultOctLCTree>(
//         porep_config,
//         cache_dir_path,
//         staged_file.path(),
//         replica_path,
...
//     validate_cache_for_commit::<_, _, DefaultOctLCTree>(cache_dir_path, replica_path)
...
//     clear_cache::<DefaultOctLCTree, DefaultPieceHasher>(cache_dir_path)
...
// pub fn generate_priv_replica_info_fixture(
// ) -> BTreeMap<SectorId, PrivateReplicaInfo<DefaultOctLCTree>> {
...
//     let mut priv_replica_infos: BTreeMap<SectorId, PrivateReplicaInfo<DefaultOctLCTree>> =
//         BTreeMap::new();
...
//     priv_replica_info: &BTreeMap<SectorId, PrivateReplicaInfo<DefaultOctLCTree>>,
// ) -> Vec<Candidate> {
//     generate_candidates(
//         &POST_CONFIG,
//         &CHALLENGE_SEED,
